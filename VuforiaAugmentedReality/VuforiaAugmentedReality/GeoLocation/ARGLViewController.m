...
@implementation ARGLViewController
...
- (void)loadView {
    ...
    // arViewController.view's subview has EAGLView as it's view
    [parentView addSubview:arViewController.view];
    mainARView = [[arViewController.view subviews] objectAtIndex:0];
    [parentView addSubview: ar_overlayView];
...
//	[self presentModalViewController:self.cameraController animated:NO];
	...
	[ar_overlayView setFrame:self.view.bounds];
#endif
...
//	tempCoordinate.title = @"You touched down there";
    ...
    [mainARView setGeoViewActive:true];
